...
<div class="container card-3">
    ...
    <div class="row g-5">
        @foreach ($resg as $rg)
        @php
        $hasOpenApplications = $rg->applications_count > 0;
        @endphp
        <div class="col-md-6">
            <div class="card mb-4 d-flex flex-column h-100 shadow-sm position-relative">
                @if ($hasOpenApplications)
                <div class="position-absolute" style="top: 10px; right: 10px; z-index: 10;">
                    <span class="badge p-2" style="background-color: #17a2b8; color: white; font-size: 0.9rem; font-weight: 400;margin-right: 20px;">
                ...
                <div class="row g-0 flex-grow-1">
                    ...
                    <div class="col-md-8 d-flex flex-column">
                        <div class="card-body flex-grow-1 d-flex flex-column pt-5">
                            @php
                            ...
                            <h2 class="card-text-1 mt-3 ml-0">Members</h2>
