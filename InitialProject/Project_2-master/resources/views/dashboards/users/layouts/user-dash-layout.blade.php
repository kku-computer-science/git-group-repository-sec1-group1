            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text">{{ trans('message.research_info') }} <span
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('admin/profile*')) ? 'active' : '' }}"
                            ...
                            <span class="menu-title">{{ trans('message.user_profile') }}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#ManagePublications" aria-expanded="false" aria-controls="ManagePublications">
                            ...
                            <span class="menu-title">{{ trans('message.manage_publications') }}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('users.index')}}">
                            ...
                            <span class="menu-title">{{ trans('message.users') }}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('roles.index')}}">
                            ...
                            <span class="menu-title">{{ trans('message.roles') }}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('departments.index')}}">
                            ...
                            <span class="menu-title">{{ trans('message.departments') }}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('programs.index')}}">
                            ...
                            <span class="menu-title">{{ trans('message.manage_programs') }}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('experts.index')}}">
                            ...
                            <span class="menu-title">{{ trans('message.manage_expertise') }}</span>
