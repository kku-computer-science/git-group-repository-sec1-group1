            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        ...
                        document.getElementById ('logout-form').submit();"> <?php echo e(__('message.logout')); ?> <i class="mdi mdi-logout"></i></a>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ManagePublications">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="/patents"><?php echo e(__('message.other_academic_works')); ?></a></li>
                            </ul>
                        </div>
                    </li>
                    <?php endif; ?>
